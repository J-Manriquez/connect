...
class _ColorFieldState extends State<ColorField> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      final fallback = _colorToHex(Colors.white);
      ...
      setState(() {
        _previewColor = c ?? Color.fromRGBO(1, 68, 169, 1.0);
        _errorMessage = null;
  ...
  void _openColorPicker() async {
    ...
    final workingColor = _previewColor ?? const Color.fromRGBO(1, 68, 169, 1.0);
    ...
    return Column(
      ...
      children: [
        ...
        Slider(
          ...
          onChanged: onChanged,
          activeColor: Color.fromRGBO(1, 68, 169, 1.0),
          inactiveColor: Color.fromRGBO(1, 68, 169, 1.0).withOpacity(0.3),
        ),
      ],
    );
  }
        ...
        ? GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _previewColor,
                border: Border.all(color: Color.fromRGBO(1, 68, 169, 1.0)),
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: Color.fromRGBO(1, 68, 169, 1.0).withOpacity(0.2),
              width: 1,
            ),
            boxShadow: [
              BoxShadow(
            ...
            child: Row(
              children: [
                Expanded(
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      prefixIcon: Icon(Icons.palette, color: Color.fromRGBO(1, 68, 169, 1.0)),
                ...
                IconButton(
                    ...
                    showDialog(
                      ...
                      builder: (context) => AlertDialog(
                        ...
                        shape: RoundedRectangleBorder(
                          ...
                          side: BorderSide(color: Color.fromRGBO(1, 68, 169, 1.0), width: 1),
                        ),
                        title: Text(
                          'Formatos de Color',
                  ...
                  icon: Icon(Icons.help_outline, color: Color.fromRGBO(1, 68, 169, 1.0)),
...
class _ColorPickerScreenState extends State<_ColorPickerScreen> {
  static const _brandColor = Color.fromRGBO(1, 68, 169, 1.0);
    ...
    return Column(
      ...
      children: [
        ...
        Slider(
          ...
          inactiveColor: _brandColor.withOpacity(0.3),
        ),
      ],
    );
  }
